...
import CardElement from '../components/CardElement';import Image from 'next/image';
...
function UserProfile({Quote}) {
    ...
    return (
       ...
       <div>
        ...
        className="btn btn-xs sm:btn-sm md:btn-md lg:btn-lg w-[100px] h-[40px] text-lg bg-blue-500">Follow</button>
        </div>
        <div className="w-full  flex gap-1 flex-wrap p-1">
          {
