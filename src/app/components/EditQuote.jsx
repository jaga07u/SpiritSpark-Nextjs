...
function EditQuote({Data}) {
  ...
  return (
    <div className={ `absolute w-screen h-[100vh] text-white overflow-x-hidden z-50 my-[${hidden}]`} style={{backgroundImage:'url("https://geniebook.com/cms/storage/app/media/pri.-science-blog/adobestock-301377172.webp")',backgroundRepeat:"no-repeat",backgroundPosition:"center",backgroundSize:"cover"}}>
