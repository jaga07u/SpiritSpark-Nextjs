...
//     const res = await axios.post(`https://spirit-spark-backendv2.onrender.com/api/v1/like/story`, { storyId: id },{withCredentials:true, headers: {
...
//           </div>
//     </div>
//     <div className="w-full h-[420px] flex justify-center items-center p-2 flex-wrap  " style={{backgroundImage:`url(${Data?.BgImageUrl})`,backgroundAttachment:"scroll",backgroundPosition:"center",backgroundRepeat:"no-repeat",backgroundSize:"cover"}}>
       
//       <h1 className="text-2xl"> {Data?.story}</h1>
//     </div>
...
const handleFollow = async (id) => {
   ...
   setFollowing(!following);
    const res = await axios.post(`https://spirit-spark-backendv2.onrender.com/api/v1/follow/${id}`,{},{
